...
rakes1 <- plants[SURVEY_ID %in% plants[!is.na(REL_ABUND)  ,
...
rakes1[SURVEY_ID %in% plants[!is.na(REL_ABUND)  , max(REL_ABUND) , SURVEY_ID ][V1 == 4,SURVEY_ID] &
         REL_ABUND == 3 , REL_ABUND := 2 ]
rakes1[SURVEY_ID %in% plants[!is.na(REL_ABUND)  , max(REL_ABUND) , SURVEY_ID ][V1 == 4,SURVEY_ID] &
         REL_ABUND == 4 , REL_ABUND := 3 ]

#1-5 surveys shifted to 1-3
rakes1[SURVEY_ID %in% plants[!is.na(REL_ABUND)  , max(REL_ABUND) , SURVEY_ID ][V1 == 5,SURVEY_ID] &
